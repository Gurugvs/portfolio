...
export const Footer = () => {
  ...
  const socialLinks = [
    { icon: Github, href: "https://github.com/Gurugvs", label: "GitHub" },
    { icon: Linkedin, href: "https://www.linkedin.com/in/guru-thiyanesh-b189b3380", label: "LinkedIn" },
    { icon: Mail, href: "mailto:guru2005savi@gmail.com", label: "Email" },
    { icon: Phone, href: "tel:+917448577857", label: "Phone" },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10 flex flex-col gap-10">
        ...
        <div className="pt-6 border-t border-black/5 dark:border-white/10 flex flex-col md:flex-row items-center justify-between gap-6 text-xs text-muted-foreground">
          ...
          <div className="flex items-center gap-1.5 font-medium text-center md:text-right">
            <span>© {new Date().getFullYear()} Guru Thiyanesh V  ❤️ ❗</span>
          </div>
        </div>
