        ...
        >
          ...
          >
            ...
            <div className="block dark:hidden">
              <span className="bg-gradient-to-r from-violet-600 via-sky-500 via-purple-600 to-indigo-600 bg-clip-text text-transparent font-extrabold text-[clamp(2.75rem,6vw,5rem)] leading-none tracking-tight block pb-2 select-none">
                Guru Thiyanesh V
              </span>
            </div>
          ...
          >
            Motivated Computer Science and Engineering student with a strong foundation in Web Development, IoT smart systems, computer hardware, and troubleshooting.
          </motion.p>
          ...
          >
            ...
            <a href="/resume.pdf" target="_blank" rel="noopener noreferrer" download="Guru_Thiyanesh_Updated_Resume.pdf">
          ...
          >
            <div className="flex flex-col h-full bg-card w-full">
              ...
              <div className="p-5 flex flex-col items-center text-center bg-card text-card-foreground flex-1 gap-3">
                <div>
                  <h3 className="text-xl font-extrabold tracking-tight text-foreground">Guru Thiyanesh V</h3>
                  <div className="inline-flex items-center gap-1.5 mt-1 px-3 py-0.5 rounded-full bg-primary/10 border border-primary/30 text-primary text-xs font-semibold">
                    <span>B.E. Computer Science & Engg</span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-2.5 w-full text-left bg-muted/40 p-3 rounded-xl border border-border/50">
                  <div>
                    ...
                    <span className="font-bold text-foreground text-xs">Web, IoT & Hardware</span>
                  </div>
                  <div>
                    <span className="text-muted-foreground block text-[9px] uppercase tracking-widest font-bold">Location</span>
                    <span className="font-bold text-foreground text-xs">Karur, Tamil Nadu</span>
                  </div>
                  <div>
                    <span className="text-muted-foreground block text-[9px] uppercase tracking-widest font-bold">College</span>
                    <span className="font-bold text-foreground text-xs">Chettinad Tech</span>
                  </div>
                  <div>
                ...
                <div className="flex flex-col items-center mt-1 w-full gap-1">
                  ...
                  <div className="flex items-center justify-between w-full px-1 text-[10px]">
                    ...
                    <span className="text-muted-foreground font-semibold text-[9px] tracking-wider">
                      グル・ティヤネシュ
                    </span>
                  </div>
                </div>
