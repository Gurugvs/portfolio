  ...
  const education = [
    {
      ...
      icon: GraduationCap,
      details: [
        "Focus on Web Development, IoT smart systems, and algorithms",
        "Built IoT-based real-time Air & Noise Pollution detection system",
        "Active student developer and open source enthusiast"
      ]
    },
    {
      degree: "Diploma in Computer Engineering",
      school: "The Karur Polytechnic College",
      year: "2020 – 2023",
      ...
      icon: BookOpen,
      details: [
        "In-depth foundations in C/C++, hardware architecture, and networks",
        "Served as Lab Assistant maintaining lab systems and assisting peers",
        "Gained hands-on database management experience with MySQL"
      ]
    },
    {
      ...
      icon: BookOpen,
      details: [
        "Strong fundamental grounding in Mathematics, Physics, and Science",
        "Developed early interest in computing, logic, and hardware mechanics"
      ]
    }
  ];
      ...
      <div>
        ...
        >
          ...
          <p className="text-muted-foreground text-lg max-w-2xl">
            Formal education in Computer Science and Engineering establishing strong engineering principles and practical mastery.
          </p>
        </motion.div>
